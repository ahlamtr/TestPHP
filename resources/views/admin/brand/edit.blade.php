    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>{{Lang::get('messages.menu.admin.brand.edit')}}</h2>
                    ...
                    <div class="x_content">
                        ...
                        {{ Form::open(array('url' => '/admin/brand/edit',"class"=>"form-horizontal form-label-left","id"=>"addForm","enctype"=>"multipart/form-data")) }}

                        <div class="col-md-12 clearfix">

                            <div class="form-group ">
                                <label >{{Lang::get('messages.menu.admin.brand.name')}}</label>
                                <input type="text" value="{{$brand->name}}" name="name" placeholder="{{Lang::get('messages.menu.admin.brand.name')}}" data-bv-notempty="true" class="form-control ">                            
                            </div>
                        </div>
